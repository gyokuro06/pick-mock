...
const onGoback = () => router.push('/order/pickup')
...
<style scoped>
.delivery-dest-detail-input-form {
  margin: 0 3rem;
}
.delivery-dest {
  text-align: left;
...
.contact-person-name__title--required {
  border-width: 2px;
  border-style: solid;
  border-radius: 3px;
  padding: 0.2em 0.3em;
